...
class GazeTracking(object):
    ...
    def get_left_eyesize(self):
        """Returns width and height of user left eyes"""
        if self.pupils_located:
            width_height = self.eye_left.widthNheight 
            return width_height
    
    def get_right_eyesize(self):
        """Returns width and height of user left eyes"""
        if self.pupils_located:
            width_height = self.eye_right.widthNheight 
            return width_height
